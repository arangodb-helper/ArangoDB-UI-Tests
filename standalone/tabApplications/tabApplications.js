...
casper.then(function() {
  ...
  phantomcss.screenshot("#content #installedList li.tile:first-of-type", "activeApplicationTile");
  phantomcss.screenshot("#content #availableList li.tile:first-of-type", "availableApplicationTile");
});
